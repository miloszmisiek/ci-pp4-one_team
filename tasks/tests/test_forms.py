...
class TestForms(TestCase):
    ...
    def test_add_task_form_metafields_explicit(self):
        """Test the add task form - fields match the model with assigned_to argument passed in"""
        ...
        form = AddTask(assigned_to=ALL_USERS,
            data={
                'title': 'title',
    ...
    def test_add_task_form_start_date_accepts_only_date_values(self):
        """Test the add task form - user input start date with incorect date format"""
        ...
        with self.assertRaises(TypeError): # for clean method called when AddTask instance created
    ...
    def test_add_task_form_end_date_accepts_only_date_values(self):
        """Test the add task form - user input end date with incorect date format"""
    ...
    def test_add_task_form_assigned_to_no_value(self):
        ...
        self.assertEqual(form.errors['assigned_to'][0], "Select a valid choice. That choice is not one of the available choices.")
    ...
    def test_add_task_form_start_date_greater_than_end_date(self):
        """Test the add task form - start_date greater than end_date  raises error"""
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(form.errors['__all__'][0], "End date should be greater or equal than start date.")