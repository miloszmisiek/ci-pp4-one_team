...
class TestForms(TestCase):
    ...
    def test_user_signup_form_placeholders(self):
        ...
        self.assertEqual(
            form.fields["email"].widget.attrs["placeholder"], "E-mail address"
        )

        self.assertEqual(
            form.fields["email2"].widget.attrs["placeholder"], "Confirm e-mail"
        )
    ...
    def test_user_signup_form_emails_no_match(self):
        ...
        self.assertEqual(
            form.errors["email2"][0], "You must type the same email each time."
        )
    ...
    def test_user_signup_form_password1_no_match(self):
        ...
        self.assertIn("password2", form.errors.keys())
        self.assertEqual(
            form.errors["password2"][0], "You must type the same password each time."
        )
    ...
    def test_my_custom_reset_password_form_password2_placeholder(self):
        ...
        form = MyCustomResetPasswordKeyForm(
            data={"password1": "passwo34rd", "password2": "passwo34rd"}
        )
        print(form.errors)
        self.assertTrue(form.is_valid())
        self.assertEquals(len(form.errors), 0)
        self.assertEqual(
            form.fields["password2"].widget.attrs["placeholder"], "Repeat New Password"
        )
